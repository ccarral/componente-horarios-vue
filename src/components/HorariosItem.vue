                        ...
                        <td>
                            <ul v-if="poolContainer.pools" class="subjects">
                                ...
                                >
                                    <div class="subject">
                                        <li>
                                            Materia: {{ poolContainer.subjects[idx].name }}
                                            <br />
                                        </li>
                                    </div>
                                </a>
...
import ResultadosHorarios from "./ResultadosHorarios.vue";
